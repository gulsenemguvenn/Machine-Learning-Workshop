...
print("Forest Doğruluğu:", accuracy_score(y_test,forest_pred))

svm_model = SVC()
svm_model.fit(x_train,y_train)
svm_pred = svm_model.predict(x_test)

print("SVC Doğruluğu:", accuracy_score(y_test,svm_pred))
...
print("Forest Tahmini:", iris.target_names[predict_forest[0]])
